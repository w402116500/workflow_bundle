...
9. 如需 AI 场景插图，先执行 `python3 workflow_bundle/tools/cli.py prepare-ai-figures --config <workspace-dir>/workflow/configs/workspace.json`
10. 完成正文后执行 `python3 workflow_bundle/tools/cli.py prepare-figures --config <workspace-dir>/workflow/configs/workspace.json`
11. 如果本轮修改了 workflow 工具、workflow 技能或 workflow 文档，再执行 `python3 workflow_bundle/tools/cli.py selftest`
